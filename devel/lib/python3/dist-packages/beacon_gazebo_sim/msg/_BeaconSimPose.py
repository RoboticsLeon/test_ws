...
"""autogenerated by genpy from beacon_gazebo_sim/BeaconSimPose.msg. Do not edit."""
import codecs
import sys
...
class BeaconSimPose(genpy.Message):
  _md5sum = "f8d8b1b45348d9f15bc89abfd901786e"
  _type = "beacon_gazebo_sim/BeaconSimPose"
...
float64 z
"""
  __slots__ = ['id','time_stamp','frame_id','position']
  _slot_types = ['string','time','string','geometry_msgs/Point']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       id,time_stamp,frame_id,position
    ...
    """
    if args or kwds:
      super(BeaconSimPose, self).__init__(*args, **kwds)
